...
function scanUploadedImage(file) {
  ...
  stopScanner().then(async () => {
    ...
    try {
      ...
      const previewImgBox = document.createElement('div');
      previewImgBox.className = 'scan-preview-img-box';
      previewImgBox.appendChild(thumb);
      previewWrap.appendChild(previewImgBox);
      const previewMeta = document.createElement('div');
      previewMeta.className = 'scan-preview-meta';
      const previewName = document.createElement('span');
      previewName.className = 'scan-preview-name';
      previewName.textContent = file.name || 'uploaded-image.png';
      const previewLabel = document.createElement('span');
      previewLabel.className = 'scan-preview-label';
      previewLabel.textContent = 'Image uploaded';
